    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <>
          ...
          <div
            className={`
              z-50 border border-white/[0.08] bg-[#0a0a0b] shadow-2xl shadow-black/60 overflow-hidden
              sm:absolute sm:bottom-full sm:right-0 sm:mb-2 sm:w-[360px] sm:rounded-xl
              fixed bottom-0 left-0 right-0 rounded-t-2xl
            `}
            style={{ animation: "slideUpFade 0.15s ease-out forwards" }}
          >
            {/* Header */}
